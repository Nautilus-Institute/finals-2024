...
uint64_t verify(uint32_t round_num, uint64_t codeword) {
    ...
    for(int i = 0; i < 6; i++){
        ...
        uint32_t v5 = u32(__rol32__(u32(((not32(v3) & v2) | (v1 & v3)) + v4 - 0x7ac8a754), 7) + v3);
        uint32_t v6 = not32(__rol32__(u32(((u32(v3) & v2) | (v1 & v3)) + v4 + 0x66fe5a55), 5) + v3);
        ...
        uint32_t v11 = u32(__rol32__(u32(((u32(v7) & v10) | (v9 & v8)) + v4 + 0x1144a8e0), 22) + v7);
    ...
    return (v3 == 3388735471u) && (v4 == 4104563092u);
}